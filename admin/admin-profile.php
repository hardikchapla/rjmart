                                        ...
                                        <div class="info">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-2 col-lg-2 col-md-4">
                                                            <div class="upload mt-4 pr-md-4">
                                                                <input type="file" id="file" class="dropify" data-default-file="assets/img/<?= $profile1['avatar'] ?>" data-max-file-size="2M" name="photo" />
                                                                <input type="hidden" id="image" name="image" class="form-control" value="<?= $profile1['avatar'] ?>"/>
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="fullName" placeholder="Full Name" value="<?= $profile1['name'] ?>" name="fullName">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="userName" placeholder="Username" value="<?= $profile1['username'] ?>" name="userName">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control" id="email" placeholder="Email" value="<?= $profile1['email'] ?>" name="email">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="number" placeholder="Number" value="<?= $profile1['number'] ?>" name="number">
                                            ...
                                            <div class="text-center mt-3">
                                                <div class="field-wrapper">
                                                    <button type="submit" class="btn btn-primary btn-theme-color update-profile" value="">Update Profile</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                                ...
                                                <div class="col-md-12 mx-auto">
                                                   <div class="col-sm-6">
                                                    ...
                                                    <div class="text-center mt-4">
                                                        <div class="field-wrapper">
                                                            <button type="submit" class="btn btn-primary btn-theme-color change-password" value="">Change Password</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $("#update-password").on('submit',(function(e)
            {
                ...
                e.preventDefault();
                $.ajax({
                    url: "code/admin_change_pass.php",
                    method: 'POST',
                    data: new FormData(this),
                    contentType: false,
                    processData: false,
