                                            ...
                                            <div class="custom-file-container" data-upload-id="myFirstImage">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-file-dummy"
                                                        placeholder="Choose file" aria-describedby="fileHelp" required
                                                        name="dummyImg" id="dummyImg">
                                                    ...
                                                    <label class="input-group-append mb-0">
                                                        <span class="btn btn-primary input-file-btn">
                                                            Browse… <input type="file" hidden name="cat_profile[]"
                                                                id="cat_profile" multiple data-show-upload="true"
                                                                data-show-caption="true" required>
                                                        </span>
                                                    </label>
                                                </div>
                                                <input type="hidden" id="cat_profile1" name="cat_profile1"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom05"
                                                placeholder="Name of The Category" required name="cat_name">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing" id="category-list-box">
                        <div class="widget-content widget-content-area br-6">
                            <div class="add-category">
                                <button class="btn btn-primary float-right" onclick="formReset()" type="button"
                                    id="add-category">Add New</button>
                            </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                data.forEach(function(item) {
                    $("#img-list").append("<div class='col-md-3 col-xs-6 image_delete' id='" + item
                        .id + "'><img src='../assets/img/product/" + item.image +
                        "' style='width:100%;height:200px;object-fit: cover;'><div class='text-center'><a class='btn btn-danger mt-2' onclick='delete_product_image(" +
                        item.id + ",\"" + item.image + "\")'>Delete</a></div></div>");
                });
            },
            error: function(data) {
                console.log(data);
