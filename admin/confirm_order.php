...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var dataTable1 = $('#display_order_request').DataTable({
            "ajax": {
                url: "code/display_confirm_orders.php",
                type: "POST"
            }
        });
    });
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.shippedorder', function(e) {
    ...
    function SwalStatusChange(order_id) {
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to shipped this order?",
            type: 'warning',
