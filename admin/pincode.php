...
<body>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input type="number" class="form-control" id="validationCustom05"
                                                placeholder="Enter Pincode" required name="pincode_no">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing" id="category-list-box">
                        <div class="widget-content widget-content-area br-6">
                            <div class="add-category">
                                <button class="btn btn-primary float-right" type="button" id="add-pincode">Add
                                    New</button>
                            </div>
                            <div class="table-responsive mb-4 mt-5">
                                <table id="display_pincode" class="table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Pincode</th>
    ...
    $(document).ready(function() {
        var dataTable = $('#display_pincode').DataTable({
            "ajax": {
                url: "code/display_pincode",
                type: "POST"
            }
        });
    });
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        $('#add-pincode').on('click', function(e) {
            $('.add-cat-box').show();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (obj.error == 'success') {
                    swal({
                        title: 'Pincode has been inserted successfully',
                        text: "",
                        type: 'success',
                        timer: 3000,
                        padding: '2em',
    ...
    <script type="text/javascript">
    $(document).on('click', '.updatePincode', function() {
        $('.add-cat-box').show();
        $('#category-list-box').hide();
        var pincode_id = $(this).attr("id");
        $.ajax({
            url: "code/update_pincode",
            method: "POST",
            data: {
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.deletePincode', function(e) {
            var pincode_id = $(this).attr("id");
            SwalDelete(pincode_id);
            e.preventDefault();
        });
    });

    function SwalDelete(pincode_id) {
        Swal.fire({
            title: 'Are you sure?',
                ...
                return new Promise(function(resolve) {
                    $.ajax({
                        ...
                        .done(function(response) {
                            swal({
                                title: 'Pincode has been deleted successfully',
                                text: "",
                                type: 'success',
                                timer: 3000,
                                padding: '2em',
