...
if($fStartDate == '' && $lEndDate == ''){
    ...
    $query = "SELECT sum(total_amount) as total_amount FROM product_order WHERE order_status = 2 AND convert(date,(convert(varchar(20),'created'))) BETWEEN '$fStartDate' AND '$lEndDate'";
}
