        ...
        <div class="dropdown-item">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    if($fenoti['type'] == 'new_register'){
                        ?>
                        <div class="notification-para"><span class="user-name"><?= $feuser['fullname'] ?></span><a href="user-details.php?id=<?= $fenoti['sender_id'] ?>"> <?= $fenoti['message'] ?></a></div>
                        <?php
                    } else {
                        ?>
                        <div class="notification-para"><span class="user-name"><?= $feuser['fullname'] ?></span><a href="user-orders.php?id=<?= $fenoti['order_id'] ?>"> <?= $fenoti['message'] ?></a></div>
                        <?php
                    }
                    ?>
                </div>
