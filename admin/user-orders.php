                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <button class="btn btn-info view_plan_details" data-toggle="modal" data-target="#exampleModal1" >Invoice</button>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-3">
                                <p><?= ($feorder['order_date'] == '0000-00-00 00:00:00') ? '':date('d, M Y H:i a',strtotime($feorder['order_date'])) ?></p>
                            </div>
                        </div>
                        <hr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var dataTable1 = $('#display_order').DataTable({
            "ajax": {
                url: "code/display_order_details.php",
                type: "POST",
