...
<body>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing" id="category-list-box">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-5">
                                <table id="display_terms" class="table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Slug</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Terms and condition Details</h5>
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        var dataTable = $('#display_terms').DataTable({
            "ajax": {
                url: "code/display_terms",
                type: "POST"
            }
        });
    });
    ...
    $(document).on('submit', '#add-category-form', function(event) {
        ...
        event.preventDefault();
        $.ajax({
            url: "code/edit_terms_and_condition",
            method: 'POST',
            ...
            success: function(response) {
                ...
                if (obj.error == 'success') {
                    swal({
                        title: 'Terms & Condition has been inserted successfully',
                        text: "",
                        type: 'success',
                        timer: 3000,
                        padding: '2em',
                    ...
                    swal({
                        title: 'Terms & Condition has been updated successfully',
                        text: "",
                        type: 'success',
                        timer: 3000,
                        padding: '2em',
    ...
    $(document).on('click', '.updatePrivacyPolicy', function() {
        ...
        $.ajax({
            url: "code/update_terms_and_condition",
            method: "POST",
            data: {
                terms_id: terms_id
            },
