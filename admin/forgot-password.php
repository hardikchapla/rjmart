                        ...
                        <div class="form-form-wrap">
                            <div class="form-container">
                                <div class="form-content">
                                    ...
                                    <p class="signup-link recovery">Enter your email and instructions will sent to you!
                                    </p>
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="d-sm-flex justify-content-between">
                                                ...
                                                <div class="field-wrapper">
                                                    <button type="submit" class="btn btn-primary btn-theme-color"
                                                        value="">Reset</button>
                                                </div>
                                            </div>
                                            <div class="login-again">
                                                <span>Did you remember?<a href="index.php" class="forgot-pass-link">
                                                        Sign In</a></span>
                                            </div>
                                        </div>
                                    </form>
